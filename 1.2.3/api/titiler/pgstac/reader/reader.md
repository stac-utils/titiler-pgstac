...
class PgSTACReader(
    ...
    include_asset_types: Set[str] = {'image/vnd.stac.geotiff; cloud-optimized=true', 'application/x-hdf', 'image/x.geotiff', 'image/tiff; application=geotiff; profile=cloud-optimized', 'application/x-hdf5', 'image/jp2', 'image/tiff; profile=cloud-optimized; application=geotiff', 'image/tiff; application=geotiff', 'image/tiff'},
