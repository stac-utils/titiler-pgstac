...
class PgSTACReader(
    ...
    include_asset_types: Set[str] = {'image/tiff', 'application/x-hdf', 'image/tiff; application=geotiff; profile=cloud-optimized', 'image/x.geotiff', 'image/tiff; profile=cloud-optimized; application=geotiff', 'application/x-hdf5', 'image/jp2', 'image/tiff; application=geotiff', 'image/vnd.stac.geotiff; cloud-optimized=true'},
