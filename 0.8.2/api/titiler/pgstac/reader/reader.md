...
class PgSTACReader(
    ...
    include_asset_types: Set[str] = {'application/x-hdf5', 'image/x.geotiff', 'image/tiff; application=geotiff; profile=cloud-optimized', 'image/tiff; profile=cloud-optimized; application=geotiff', 'image/vnd.stac.geotiff; cloud-optimized=true', 'image/jp2', 'image/tiff', 'image/tiff; application=geotiff', 'application/x-hdf'},
