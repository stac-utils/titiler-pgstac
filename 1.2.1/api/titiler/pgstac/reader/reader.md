...
class PgSTACReader(
    ...
    include_asset_types: Set[str] = {'image/tiff; application=geotiff', 'image/tiff', 'image/vnd.stac.geotiff; cloud-optimized=true', 'image/jp2', 'image/tiff; application=geotiff; profile=cloud-optimized', 'application/x-hdf', 'image/x.geotiff', 'image/tiff; profile=cloud-optimized; application=geotiff', 'application/x-hdf5'},
