...
class PgSTACReader(
    ...
    include_asset_types: Set[str] = {'image/tiff; application=geotiff; profile=cloud-optimized', 'application/x-hdf', 'image/x.geotiff', 'image/vnd.stac.geotiff; cloud-optimized=true', 'image/tiff', 'image/jp2', 'image/tiff; profile=cloud-optimized; application=geotiff', 'image/tiff; application=geotiff', 'application/x-hdf5'},
