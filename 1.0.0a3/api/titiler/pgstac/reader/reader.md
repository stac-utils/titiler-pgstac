...
class PgSTACReader(
    ...
    include_asset_types: Set[str] = {'image/x.geotiff', 'image/tiff; application=geotiff; profile=cloud-optimized', 'image/tiff', 'image/tiff; profile=cloud-optimized; application=geotiff', 'image/jp2', 'application/x-hdf', 'application/x-hdf5', 'image/tiff; application=geotiff', 'image/vnd.stac.geotiff; cloud-optimized=true'},
