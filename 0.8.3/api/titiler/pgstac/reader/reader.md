...
class PgSTACReader(
    ...
    include_asset_types: Set[str] = {'image/tiff', 'image/tiff; application=geotiff', 'image/x.geotiff', 'image/vnd.stac.geotiff; cloud-optimized=true', 'image/jp2', 'application/x-hdf', 'application/x-hdf5', 'image/tiff; application=geotiff; profile=cloud-optimized', 'image/tiff; profile=cloud-optimized; application=geotiff'},
